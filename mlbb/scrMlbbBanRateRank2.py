...
print("|bgcolor(#ff9900):&color(#ffffff){&size(18){S+}}|BAN率80%以上|")
print("|bgcolor(#ff6666):&color(#ffffff){&size(18){S}}|BAN率60%以上|")
print("|bgcolor(#ff00cc):&color(#ffffff){&size(18){A+}}|BAN率40%以上|")
print("|bgcolor(#6666ff):&color(#ffffff){&size(18){A}}|BAN率20%以上|")
print("|bgcolor(#53abff):&color(#ffffff){&size(18){B}}|BAN率10%以上|")
print("|bgcolor(#0dbc0d):&color(#ffffff){&size(18){C}}|BAN率10%未満|")
print("[END]")
