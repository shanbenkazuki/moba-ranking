...
DISPLAY_URL = "https://mobile-legends.fandom.com/wiki/Alpha"
WAIT_TIME = 10
...
# element = soup.select_one('#mw-content-text > div.mw-parser-output > aside:nth-child(4) > div:nth-child(3) > div')
